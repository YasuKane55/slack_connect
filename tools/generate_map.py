...
text(W/2,38,"プーブタウン ロケーションマップ（v3）",fs=24,weight="bold")
...
zone(40,250,480,520,"── 西：ものづくり・工場エリア ──",C_CRAFT,[
 ("ミラクルスタジオ(巨大倉庫2F)",C_CRAFT),("ネンシャ(デザイン)",C_CRAFT),("コトハナ(企画)",C_CRAFT),
...
zone(1000,250,480,520,"── 東：たべもの・喫茶エリア ──",C_FOOD,[
 ("中華まんぷく軒",C_FOOD),("オハラカレー&BAR(壁画A22)",C_FOOD),("まるた食堂(朝市)",C_FOOD),
